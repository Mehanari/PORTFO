        ...
        <div className="flex flex-row flex-wrap justify-center">
          {protfolioData.projects.map((project, index) => (
            <div
              ...
              <p
                className="border-2 rounded-2xl w-full border-gray-500 text-center font-semibold mt-4 p-2">{project.name}</p>
              <div className="w-full">
                <a
                  className="block break-words px-4 justify-center text-center text-black text-base font-medium underline leading-tight mt-4 hover:text-orange-500"
